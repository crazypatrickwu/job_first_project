...
//	const CURL_TIMEOUT 		= 30;
	...
	public function setConfig(){
		$public_account		= M('public_account')->where(array('redid'=>$this->Rid))->field(array('app_id','app_secret','wx_pay_key','wx_pay_mchid','wx_pay_sslcert_path','wx_pay_sslkey_path','apiurl'))->find();
		...
		C('NOTIFY_URL',$public_account['apiurl'].'/Home/Pay/wxPaySuccess/Rid/'.$this->Rid);
		C('CURL_TIMEOUT',30);
	}
}
?>