				...
				<div class="well">
				    <div id="myTabContent" class="tab-content">
				      <div class="tab-pane active in" id="home">
						        ...
						        <label>是否锁定</label>
						        <div class="radio-box">
							        <input type="radio" name="is_lock" value="1" id="is_lock_1" style="vertical-align:middle; margin-top:-2px; margin-bottom:1px;" <?php if(($agentInfo["is_lock"]) == "1"): ?>checked<?php endif; ?>/>
							        <label for="is_lock_1" style="vertical-align:middle; margin-top:-2px; margin-bottom:1px;display:initial;">是</label>&nbsp;
							        <input type="radio" name="is_lock" value="0" id="is_lock_0" style="vertical-align:middle; margin-top:-2px; margin-bottom:1px;" <?php if(($agentInfo["is_lock"]) != "1"): ?>checked<?php endif; ?>/>
