...
<head>
    ...
    <title>银行信息-<?php echo (APP_NAME); ?>后台管理系统</title>
    ...
    <div id="contentwrapper" class="contentwrapper">
        <form class="stdform stdform2" action="" method="post">
            <div class="line-dete">
                <label>真实姓名</label>
                <span class="field">
                    <input type="text" id="truename" name="truename" class="smallinput" value="<?php echo ($agent_withdrawals_account['truename']); ?>" />
                </span>
            </div>
            <div class="line-dete">
                <label>支付宝账号</label>
                <span class="field">
                    <input type="text"id="alipay_account" name="alipay_account" class="smallinput" value="<?php echo ($agent_withdrawals_account['alipay_account']); ?>" />
                </span>
            </div>
            <div class="line-dete">
                <label>提现银行</label>
            ...
            <div class="line-dete">
                <label>支行名称</label>
                <span class="field">
                    <input type="text" id="bank_card" name="bank_subbranch" class="smallinput" value="<?php echo ($agent_withdrawals_account['bank_subbranch']); ?>" />
                </span>
            </div>
            ...
            <div class="line-dete">
                <label>银行卡号码</label>
                <span class="field">
                    <input type="text" id="bank_card" name="bank_card" class="smallinput" value="<?php echo ($agent_withdrawals_account['bank_card']); ?>" />
                </span>
            </div>
