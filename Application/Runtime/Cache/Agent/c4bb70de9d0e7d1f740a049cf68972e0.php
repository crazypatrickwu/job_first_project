...
<head>
    ...
    <title>玩家管理-<?php echo (APP_NAME); ?>后台管理系统</title>
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablequick">
            ...
            <?php if(empty($game_user_list)): ?><tr>
                    <td colspan="<?php echo ($cols); ?>" align="center">请输入正确的玩家ID查询信息！</td>
                </tr>
                <?php else: ?>
                <?php if(is_array($game_user_list)): $i = 0; $__LIST__ = $game_user_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$game_user): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="center"><?php echo ($game_user['money']); ?>（元）</td>
                        <td class="center"><?php echo ($game_user['registerdate']); ?></td>
                        <!-- <td class="center">
                            <a class="stdbtn btn_lime" href="<?php echo U('Recharge/addInsureScore', array('user_id'=>$game_user['userid']));?>">充卡</a>&nbsp;&nbsp;
                        </td> -->
