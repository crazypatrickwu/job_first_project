...
$(document).on("touchstart",".dropdown-menu li",function(e){
    ...
    <div class="sidebar-nav">
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<form id="AgentForm" action="<?php echo U('Agent/editAgent');?>" method="post">
				<div class="well">
				    <div id="myTabContent" class="tab-content">
				      <div class="tab-pane active in" id="home">
						        <label>昵称</label>
						        <input type="text" id="nickname" name="nickname" class="input-xlarge" value="<?php echo ($agentInfo['nickname']); ?>" />
                                <label>手机号</label>
                                <input type="text" id="phone" class="input-xlarge" value="<?php echo ($agentInfo['phone']); ?>" readonly />
						        <label>微信号</label>
						        <input type="text" id="wechat_id" name="wechat_id" class="input-xlarge" value="<?php echo ($agentInfo['wechat_id']); ?>" />
						        <label>邀请码</label>
						        <input type="text" id="invitation_code" class="input-xlarge" value="<?php echo ($agentInfo['invitation_code']); ?>" readonly />
                                <label>累计收益</label>
                                <input type="text" id="accumulated_income" class="input-xlarge" value="<?php echo ($agentInfo['accumulated_income']); ?>" readonly />
                                <label>可提现余额</label>
                                <input type="text" id="available_balance" class="input-xlarge" value="<?php echo ($agentInfo['available_balance']); ?>" readonly />
						        <!-- <label>所在区域</label>
						        ...
						        <label>详细地址</label>
						        <input type="text" name="address" class="input-xlarge"  value="<?php echo ($agentInfo['address']); ?>" />
						        <label>服务城市</label>
						        <input type="text" name="service_city" class="input-xlarge"  value="<?php echo ($agentInfo['service_city']); ?>" /> -->
				      </div>
				  	</div>
				</div>
...
CommonJs.FormCheck	= function(FormObj){
	...
	if(!CheckJs.required(CommonJs.SubmitData.nickname)){
		_inform('请输入昵称',function(){CommonJs.Loading = false;});return false;
	}
	if(!CheckJs.required(CommonJs.SubmitData.wechat_id)){
		_inform('请输入微信号',function(){CommonJs.Loading = false;});return false;
	}
