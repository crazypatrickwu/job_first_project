        ...
        <div class="container-fluid">
		  ...
		  <div class="search-well">
		      <form class="form-inline" action="" metod="get">
		          <input class="input-xlarge" id="appendedInputButton" type="text" name="keyword" value="<?php echo remove_xss(I('get.keyword'));?>" placeholder="请输入推广员昵称/手机号/微信号进行检索" style="width:75%;margin-left:2px;">
...
<div class="well">
    <table class="table">
      <thead>
        <tr>
          <th width="10%" class="center">玩家ID</th>
          <th width="20%" class="center">提成金额</th>
          <!-- <th width="40%">描述</th> -->
          <th width="20%" class="center">时间</th>
        </tr>
      </thead>
      <tbody>
        <?php $cols = 3; ?>
      	<?php if(empty($myRechargeRecored)): ?><tr>
               <td colspan="<?php echo ($cols); ?>" align="center" style="text-align: center !important;">暂无记录~！</td>
           </tr>
        <?php else: ?>
        <?php if(is_array($myRechargeRecored)): $i = 0; $__LIST__ = $myRechargeRecored;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$recored): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td class="center" width="30%"><div style="width:100%;word-wrap:break-word;"><?php echo ($recored['money']); ?></div></td>
                <!-- <td class="center" width="40%"><div style="width:100%;word-wrap:break-word;"><?php echo ($recored['desc']); ?></div></td> -->
                <td class="center" width="40%">
                	<div style="width:100%;word-wrap:break-word;"><?php echo (time_format($recored['dateline'])); ?></div>
                </td>
