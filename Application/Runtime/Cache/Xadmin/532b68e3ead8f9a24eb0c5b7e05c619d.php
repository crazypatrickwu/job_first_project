    ...
    <div id="contentwrapper" class="contentwrapper">
        <div id="container0" style="width: 80%; margin: 0">
            <div class="chart-head-count">
                <h2><?php echo ($result["transactionCount"]); ?></h2>
                总交易量
            </div>
            <div class="chart-head-count">
                <h2><?php echo ($result["agentCount"]); ?></h2>
                代理总数
            </div>
            <div class="chart-head-count">
                <h2><?php echo ($result["wxuserCount"]); ?></h2>
                玩家总数
            </div>
            <div class="chart-head-count">
                <h2><?php echo ($result["todayTransactionCount"]); ?></h2>
                今日交易量
            </div>
            <div class="chart-head-count">
                <h2><?php echo ($result["todayWxuserCount"]); ?></h2>
                今日新增玩家
            </div>
        </div>
