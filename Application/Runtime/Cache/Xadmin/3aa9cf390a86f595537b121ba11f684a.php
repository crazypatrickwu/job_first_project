...
<head>
    ...
    <title>修改玩家邀请码-<?php echo (APP_NAME); ?></title>
    ...
    <div id="contentwrapper" class="contentwrapper">
        <form class="stdform stdform2"  onsubmit="return checkform();" method="post">
            <div class="line-dete">
                <label>玩家ID</label>
                <span class="field">
                    <?php echo ($game_user_accounts_info['userid']); ?>
                </span>
            </div>
            <div class="line-dete">
                <label>玩家昵称</label>
                <span class="field">
                    <?php echo ($game_user_accounts_info['nickname']); ?>
                </span>
            </div>
            <div class="line-dete">
                <label>邀请码</label>
                <span class="field">
                    <input style="display: none;" type="text" name="invitation_code"/>
                    <input type="text" id="invitation_code" name="invitation_code" class="smallinput" value="<?php echo ($gameuser['invitation_code']); ?>" />
                </span>
            </div>
            <div class="line-dete">
                <label>账户密码</label>
            ...
            <div class="line-dete">
                <label></label>
                <span class="field">
                    <input type="hidden" name="userid" value="<?php echo ((isset($game_user_accounts_info['userid']) && ($game_user_accounts_info['userid'] !== ""))?($game_user_accounts_info['userid']):'0'); ?>" />
