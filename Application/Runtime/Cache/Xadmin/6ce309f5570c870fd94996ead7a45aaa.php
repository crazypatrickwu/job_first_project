...
<body class="withvernav">
	...
	<div id="contentwrapper" class="contentwrapper">
		...
		<form class="stdform stdform2" action="<?php echo U(System/setting);?>" method="post">
			<?php if(is_array($configList)): $i = 0; $__LIST__ = $configList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="line-dete">
					<label><?php echo ($vo['config_name']); ?></label>
	                <span class="field">
	                	<input type="text" name="<?php echo ($vo['config_sign']); ?>" id="<?php echo ($vo['config_sign']); ?>" class="smallinput" value="<?php echo ($vo['config_value']); ?>">
