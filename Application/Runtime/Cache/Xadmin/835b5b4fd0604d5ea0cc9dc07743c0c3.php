...
<head>
    ...
    <title>玩家房卡消耗-<?php echo (APP_NAME); ?></title>
    ...
    <div id="contentwrapper" class="contentwrapper">
        <div>
            <form action="" metod="get">
                ...
                <!-- <input type="button"  value="数据导出" class="stdbtn" id="export"> -->
                 &nbsp;
                 总计：<font color='red' size='6'><?php echo ($InsureScoreCount); ?></font><font size='4'>&nbsp;（个）</font>
                <p></p>
                <p></p>
            </form>
        </div>
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablequick">
            ...
            <?php if(empty($game_user_list)): ?><tr>
                    <td colspan="<?php echo ($cols); ?>">没有数据~！</td>
                </tr>
                <?php else: ?>
                <?php if(is_array($game_user_list)): $i = 0; $__LIST__ = $game_user_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$game_user): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="center"><?php echo ($game_user['THAccountsDB']['nickname']); ?></td>
                        <td class="center"><?php echo ($game_user['THAccountsDB']['accounts']); ?></td>
                        <td class="center"><?php echo ($game_user['insurescore']); ?>（个）</td>
                        <td class="center"><?php echo ($game_user['time']); ?></td>
