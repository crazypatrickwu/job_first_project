...
<head>
    ...
    <title>充值管理-<?php echo (APP_NAME); ?></title>
    ...
    <div id="contentwrapper" class="contentwrapper">
        <div>
            <form action="" metod="get">
                <input type="text" name="keyword" id="keyword" value="<?php echo remove_xss(I('get.keyword'));?>" placeholder="请输入玩家ID或代理ID">
                &nbsp;&nbsp;&nbsp;
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablequick">
            ...
            <?php if(empty($user_recharge_recored_list)): ?><tr>
                ...
                <?php if(is_array($user_recharge_recored_list)): $i = 0; $__LIST__ = $user_recharge_recored_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user_recharge_recored): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="center">
                            <?php if($user_recharge_recored['type'] == 2): echo ($user_recharge_recored['to_agent_id']); ?>（代理）
                            <?php else: ?>
                                    <?php echo ($user_recharge_recored['user_id']); ?>（玩家）<?php endif; ?>
                        </td>
                        <td class="center"><?php echo ($user_recharge_recored['pay_nums']); ?>（张）</td>
                        <td class="center"><?php echo ($user_recharge_recored['desc']); ?></td>
                        <td class="center"><?php echo (time_format($user_recharge_recored['add_time'])); ?></td>
