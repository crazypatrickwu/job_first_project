...
<head>
    ...
    <title>提现审核-<?php echo (APP_NAME); ?></title>
    ...
    <div id="contentwrapper" class="contentwrapper">
        <form class="stdform stdform2"  onsubmit="return checkform();" method="post">
            <div class="line-dete">
                <label>代理昵称</label>
                <span class="field">
                    <?php echo ($agent_withdrawals['nickname']); ?>
                </span>
            </div>
            <div class="line-dete">
                <label>代理手机号</label>
                <span class="field">
                    <?php echo ($agent_withdrawals['phone']); ?>
                </span>
            </div>
            <div class="line-dete">
                <label>申请金额</label>
                <span class="field">
                    <?php echo ($agent_withdrawals['money']); ?>
                </span>
            </div>
            <div class="line-dete">
                <label>申请时间</label>
                <span class="field">
                    <?php echo ($agent_withdrawals['dateline']); ?>
                </span>
            </div>
            <div class="line-dete">
                <label>真实姓名</label>
                <span class="field">
                    <?php echo ((isset($agent_withdrawals['truename']) && ($agent_withdrawals['truename'] !== ""))?($agent_withdrawals['truename']):'未填写'); ?>
                </span>
            </div>
            <div class="line-dete">
                <label>支付宝</label>
                <span class="field">
                    <?php echo ((isset($agent_withdrawals['alipay_account']) && ($agent_withdrawals['alipay_account'] !== ""))?($agent_withdrawals['alipay_account']):'未填写'); ?>
                </span>
            </div>
            <div class="line-dete">
                <label>银行卡</label>
                <span class="field">
                    <?php echo ((isset($agent_withdrawals['bank_card']) && ($agent_withdrawals['bank_card'] !== ""))?($agent_withdrawals['bank_card']):'未填写'); ?>
                </span>
            </div>
            <div class="line-dete">
                <label>操作结果</label>
                <span class="field">
                    <input type="radio" name="status" value="1" />同意
                    <input type="radio" name="status" value="2" />驳回
                </span>
            </div>
            <div class="line-dete">
                <label>驳回理由<br>(注：驳回申请需填写)</label>
                <span class="field">
                    <textarea rows="10" style="width:650px;" name="reason" placeholder="请输入驳回理由..."></textarea>
            ...
            <div class="line-dete">
                <label></label>
                <span class="field">
                    <input type="hidden" name="id" value="<?php echo ((isset($agent_withdrawals['id']) && ($agent_withdrawals['id'] !== ""))?($agent_withdrawals['id']):'0'); ?>" />
