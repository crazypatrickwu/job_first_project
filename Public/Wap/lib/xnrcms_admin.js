...
function _inform(text,fn,delay,speed1,speed2){
    ...
    var informDiv = $('<div style="padding:20px 30px; background:rgba(0,0,0,0.5); color:#fff; font-size:14px; line-height:20px; position:fixed; left:50%; top:0%; z-index:9999; border-radius:10px; opacity:0; -webkit-transform:translateX(-50%); -moz-transform:translateX(-50%); -ms-transform:translateX(-50%); transform:translateX(-50%);">操作成功</div>');
